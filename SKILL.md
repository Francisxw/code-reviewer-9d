...
Ruthlessly review code across all 9 dimensions below with maximum detail and brutal honesty. For EACH dimension, you MUST explicitly state:

- **Status**: Is it OK or not?
- **Problems**: What specific issues exist (if any)?
- **Why it matters**: Potential risks, maintenance burden, readability impact, etc.
- **Concrete fixes**: Specific improvement suggestions with code snippets or diff examples where applicable

Be ruthless. Be detailed. Don't hold back.
